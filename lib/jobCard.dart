          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(placeholder, style: const TextStyle(color: Colors.white, fontSize: 17,fontWeight:FontWeight.bold),),

                Text(loc, style: const TextStyle(color: Color(0xFF8F8F9E), fontSize: 14,),),
